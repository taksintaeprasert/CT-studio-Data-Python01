...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    labelKey: 'nav.artistPerformance',
  ...
  },
  {
    ...
    icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2zM9 14l2 2 4-4',
    roles: 'all'
  },
  {
    href: '/customers',
        ...
        <div className="p-6 border-b dark:border-gray-700 flex-shrink-0">
          ...
          {user && !loading && (
            <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
              ...
              <span className="inline-block mt-1 px-2 py-0.5 text-xs font-bold rounded-full bg-pink-100 dark:bg-pink-900/30 text-pink-600 dark:text-pink-400">
